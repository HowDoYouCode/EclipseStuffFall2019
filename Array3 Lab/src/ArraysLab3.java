 ...
 * and returns an array of integers, in which every element is the sum of the elements 
 * at that index for the arrays arr1 and arr2. You can assume arrays arr1 and arr2 have at least one 
 ...
 * and returns an array of integers of length n+1 that consists of the elements of 
 ...
 * and an integer idx and returns an array of integers consisting of 
...
/* 5) Write a method rotateRight that accepts an array of integers arr 
 * and does not return a value.  The rotateRight method moves each element 
 * of arr one index to the right 
 ...
 */
	...
	*2. On their own lines print out (use Arrays.toString to transform arrays into a printable strings) :
	*sumArr
	*appendArr
	*removeArr
